...
OUTPUT_PATH_PREFIX="/pscratch/sd/d/dhaura/datasets/graph-viz/output/openTSNE/embeddings/BIG_ANN_embed"
MAX_ITER=1000
...
for i in {0..6}; do
    ...
    TEMP_SCRIPT="temp_openTSNE_tsne_viz_BIG_ANN_p_${PERPLEXITY}_size_${DATASET_SIZE}.sh"
