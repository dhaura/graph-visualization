...
INPUT_FILE_PREFIX="$SCRATCH/datasets/graph-viz/BIG_ANN/"
...
for i in {0..6}; do
    ...
    INPUT_FILE="${INPUT_FILE_PREFIX}BIG_ANN_size_${DATASET_SIZE}_adjacency.mtx"
    EMBED_FILE="${EMBED_FILE_PREFIX}BIG_ANN_embed_p_${PERPLEXITY}_size_${DATASET_SIZE}.txt"
    TEMP_SCRIPT="temp_link_pred_BIG_ANN_p_${PERPLEXITY}_size_${DATASET_SIZE}.sh"
