...
INPUT_FILE_PREFIX="/pscratch/sd/d/dhaura/datasets/graph-viz/SIFT/SIFT_subset"
OUTPUT_PATH_PREFIX="/pscratch/sd/d/dhaura/datasets/graph-viz/output/scikit-learn/embeddings/SIFT_embed"
MAX_ITER=1000
...
for i in {5..6}; do
    ...
    TEMP_SCRIPT="temp_scikit-learn_tsne_viz_SIFT_p_${PERPLEXITY}_size_${DATASET_SIZE}.sh"
